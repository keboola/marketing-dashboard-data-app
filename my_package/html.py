...
<div style="display: flex; justify-content: center;">
    ...
    <span style="font-size:1.2em;p"><strong style="display:inline-block; padding-bottom: 4%;">Metrics:</strong></span>
...
title = {
    ...
    "campaigns":'<p class="subheader">Clicks by Campaigns</p>',
    "impressions":'<p class="subheader">Clicks by Impressions</p>',
